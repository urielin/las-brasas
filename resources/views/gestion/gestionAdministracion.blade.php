                                        ...
                                        <div class="row">
                                          <div class="form-group col s12 l12 pb-2">
                                           ...
                                           <div class="col l6 m6 s6">
                                             ...
                                             <input required class="form-control browser-default" id="codigo_detalle"  name="codigo_detalle"  type="text" placeholder="ejm. I19VF20">
                                           </div>
                                         </div>
                                         <div class="form-group col s12 l12 pb-2">
                                           <label for="codigo_aux" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Auxiliar: </label>
                                           <div class="col l6 m6 s6">
                                             <input required class=" form-control browser-default" name="codigo_aux" id="codigo_aux" type="text" placeholder="ejm. AL-0451">
                                           </div>
                                         </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="estado_detalle" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Estado: </label>
                                              <div class="col l6 m6 s6">
                                                  <select class="form-control browser-default" name="estado_detalle" id="estado_detalle" placeholder="PENDIENTES DE PAGO">
                                          ...
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required name="descripcion" id="descripcion" type="text" class="browser-default form-control" placeholder="ejm. CARNE AL VACIO">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="contenido" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Cotenido: </label>
                                            <div class="col l6 m6 s6">
                                              <textarea required name="contenido" id="contenido" type="text" class="validate form-control browser-default" placeholder="ejm. 24 TON DE CARNE ENVASADA AL VACIO MARCA FRIGOCHACO A US$ 5.300 X TON"> </textarea>
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <textarea required name="observaciones" id="observaciones" type="text" class="validate form-control browser-default" placeholder="ejm. CIERRE ALMONTI AL-0451 DEL 20/11/2019"></textarea>
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="proveedor" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Proveedor: </label>
                                            <div class="col l6 m6 s6">
                                              <input required name="proveedor" id="proveedor"  type="number" class="browser-default form-control" placeholder="ejm. 100">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="marca_origen" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Marca de origen: </label>
                                              <div class="col l6 m6 s6">
                                                <input required name="marca_origen" id="marca_origen" type="number" class="browser-default form-control" placeholder="ejm. 1">
                                              </div>
                                          </div>
                                        </div>
                                        <div class="row">
                                          ...
                                          <div class="form-group col s12 l12  pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required name="fecha_cierre" id="fecha_cierre" type="text" class="browser-default form-control"  placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required step="any" name="cantidad_unidades" id="cantidad_unidades" type="number" class="browser-default form-control" placeholder="ejm. 24.40">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                          ...
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required step="any" name="monto_unitario" id="monto_unitario" type="number"  class="browser-default form-control" placeholder="ejm. 24.40">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="monto_cierre" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Total: </label>
                                            <div class="col l6 m6 s6">
                                              <input required step="any" name="monto_cierre" id="monto_cierre" type="number" class="browser-default form-control" placeholder="ejm. 24,000.30">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                          ...
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                                ...
                                                <div class="form-group col s12 l12 pb-2">
                                                  ...
                                                  <div class="col l6 m6 s6">
                                                    <input required name="fecha_embarque1" id="fecha_embarque1" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                                  </div>
                                                </div>
                                                <div class="form-group col s12 l12 pb-2">
                                                  <label for="fecha_embarque2" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Al: </label>
                                                  <div class="col l6 m6 s6">
                                                    <input required name="fecha_embarque2" id="fecha_embarque2" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group col s12 l12 pb-2">
                                                  ...
                                                  <div class="col l6 m6 s6">
                                                    <input required name="fecha_llegada1" id="fecha_llegada1" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                                  </div>
                                                </div>
                                                <div class="form-group col s12 l12 pb-2">
                                                  <label for="fecha_llegada2" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Al: </label>
                                                  <div class="col l6 m6 s6">
                                                    <input required name="fecha_llegada2" id="fecha_llegada2" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                                  </div>
                                                </div>
                                          ...
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required name="fecha_produccion" id="fecha_produccion" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="fecha_produccion2" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Al: </label>
                                            <div class="col l6 m6 s6">
                                              <input required name="fecha_produccion2" id="fecha_produccion2" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required name="fecha_vencimiento" id="fecha_vencimiento" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            <label for="fecha_vencimiento2" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Al: </label>
                                            <div class="col l6 m6 s6">
                                              <input required name="fecha_vencimiento2" id="fecha_vencimiento2" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                            </div>
                                          </div>
                                          <div class="form-group col s12 l12 pb-2">
                                            ...
                                            <div class="col l6 m6 s6">
                                              <input required name="observacion_fecha" id="observacion_fecha"  type="text" class="browser-default form-control" placeholder="ejm. CARRETERO SAN PEDRO-IQUIQUE">
                                            </div>
                                          </div>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="form-group col s12 l12 pb-2">
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input  required name="fecha_embarque" id="fecha_embarque" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required class="form-control browser-default" name="fecha_declaracion" type="text" id="fecha_declaracion" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="fecha_transbordo" id="fecha_transbordo" type="text" class="validate form-control browser-default" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="fecha_llegada_estimada" id="fecha_llegada_estimada"  type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        <label for="fecha_llegada" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Fecha ingreso bodega: </label>
                                          <div class="col l6 m6 s6">
                                            <input required name="fecha_llegada" id="fecha_llegada" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                          </div>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="form-group col s12 l12  pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                            <input required name="fecha_descarga" id="fecha_descarga" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12  pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="fecha_devolucion_contenedor" id="fecha_devolucion_contenedor" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required class="form-control browser-default" name="fecha_cumplimiento" type="text" id="fecha_cumplimiento" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="fecha_finalizacion" id="fecha_finalizacion" type="text" class="browser-default form-control" placeholder="Ingrese una fecha"  onfocus="(this.type='datetime-local')" onblur="(this.type='text')">
                                        </div>
                                      </div>
                                  ...
                                  <div class="form-horizontal form-inline">
                                    <div class="row">
                                     ...
                                     <div class="form-group col s12 l12 pb-2">
                                       ...
                                       <div class="col l6 m6 s6">
                                         <select required class="form-control browser-default" name="agencia" id="agencia">
                                           <option  value="0">Selecciona una opción</option>
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        <label for="transporte_nombre" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Transporte nombre: </label>
                                          <div class="col l6 m6 s6">
                                            <input required name="transporte_nombre" id="transporte_nombre" type="text" class="browser-default form-control" placeholder="ejm. 1.2A">
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="ingreso_zeta" id="ingreso_zeta" type="number" class="browser-default form-control" placeholder="ejm. 023">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <select required class="form-control browser-default" name="declara_origen" id="declara_origen">
                                            <option disabled selected value='0'>Selecciona una opción</option>
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required step="any" name="declara_pais_origen" id="declara_pais_origen" type="number" class="browser-default form-control" placeholder="ejm. 563 ">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required step="any" name="declara_pais_procedencia" id="declara_pais_procedencia" type="number" class="browser-default form-control" placeholder="ejm. 563">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required step="any" name="declara_puerto_embarque" id="declara_puerto_embarque" type="number" class="browser-default form-control" placeholder="ejm. 563">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="declara_almacen" id="declara_almacen" type="tex" class="browser-default form-control" placeholder="ejm. Nombre del almacenista">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required name="declara_almacen_ubic" id="declara_almacen_ubic" type="text" class="browser-default form-control" placeholder="ejm. Nombre de ubicación">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                      ...
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required  step="any" name="valor_flete" id="valor_flete" type="number" class="browser-default form-control" placeholder="ejm. 7%">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input  step="any" required name="valor_seguro" id="valor_seguro" type="number" class="browser-default form-control" placeholder="ejm. 7%">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required  step="any" name="valor_fob" id="valor_fob" type="number" class="browser-default form-control" placeholder="ejm. 137400,0000">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        <label for="valor_total" class="form-control-label col l6 m6 s6" style="text-align: right;display: inline-block;">Total $(EXT): </label>
                                        <div class="col l6 m6 s6">
                                          <input required  step="any" name="valor_total" id="valor_total" type="number" class="browser-default form-control" placeholder="ejm. 137,0000">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
                                        ...
                                        <div class="col l6 m6 s6">
                                          <input required  step="any" name="valor_total_nal" id="valor_total_nal" type="number" class="browser-default form-control" placeholder="ejm. 137,0000">
                                        </div>
                                      </div>
                                      <div class="form-group col s12 l12 pb-2">
