                      ...
                      <div class="tab-content text-center">
                          ...
                          <div class="tab-pane" id="messages">
                            ...
                            <div class=" row justify-content-center align-items-center mb-3 responsive ">
                              ...
                              {{-- <div class="row justify-content-center align-items-center mb-3"> --}}
                                ...
                                <div class="col-4">
                                  ...
                                  <button type="button" id="consulta2" class=" btn-block btn btn btn-success "  >Fechas Embarque Cierre y Llegada</button>
                                </div>
                                <div class="col-4">
                                  <button type="button" class="btn-block btn btn btn-success">Forma y Fecha de Pago</button>
                                </div>
                                {{-- </div> --}}
                            ...
                            <div class="row justify-content-center align-items-center mb-3 responsive">
                              ...
                              <div class="col-6">
                                <button type="button" class="btn-block btn btn btn-success">Valor Total del Camion</button>
                              </div>
                            </div>
              ...
              <div class="modal-body">
                ...
                <form  method="post" id="sample_form2" class="form-horizontal">
                  ...
                  <div class="row container">
                    ...
                    <div class="row pb-3">
                      ...
                      <div class="col-md">
                        ...
                        <div class="row">
                          <input type="text" name="nro_item" id="nro_item2" class="form-control">
                        </div>
                      </div>
                      <div class="col-1"></div>
                      <div class="col-md">
                        ...
                        <div class="row">
                            <input type="text" name="cantidad_ingreso" id="cantidad_ingreso2" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row pb-3">
                      ...
                      <div class="col-md">
                        ...
                        <div class="row">
                          <input type="text" name="cantidad_cierre" id="cantidad_cierre2" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row ">
                      ...
                      <div class="col-10">
                        ...
                        <div class="row">
                          <input type="text" name="bultos_ingreso" id="bultos_ingreso2" class="form-control">
                        </div>
                      </div>
                  ...
                  <div class="form-group" align="center">
                    ...
                    <input type="submit" name="action_button" id="action_button2" class="btn btn-warning" value="Actualizar">
                  </div>
                </form>
              </div>
            </div>
