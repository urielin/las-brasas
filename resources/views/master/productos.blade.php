...
@section('content')
  <div class=" " style="display: flex; flex-wrap: wrap;padding-right: 0px !important; padding-left: 0px !important;margin-top: 10px;">
      <div class=" col l3 m3 s3" style=' padding-right: 0px;padding-top:0px; margin:0px'>
        <div class="card">
                ...
                <div class="row">
                  ...
                  <div class="col l3 m3 s3">
                    <div class="form-group">
                      ...
                      <select class="form-control browser-default"   style="height:46px">
                  ...
                  <div class="container" style="margin-top: 30px">
                    ...
                    <div class="bs-example" data-example-id="form-group-height-sizes">
                      <form class="form-horizontal form-inline">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Nombre Codigo: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="edt-name" placeholder="">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Unidad de medida: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"   for="formGroupInputSmall">Mult/Unidad: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="edt-multi-unid" placeholder="">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"   for="formGroupInputSmall">Tipo Codigo: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Descripcion: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="edt-descripcion" placeholder="">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Peso / Codigo: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="edt-peso" placeholder="">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Afecto Adicional: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"  for="formGroupInputSmall">Impuesto Adicional %: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="number" id="edt-impuesto" placeholder="">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"  for="formGroupInputSmall">Codigo Arancelario: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="number" id="edt-code-arancelario" placeholder="">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"  for="formGroupInputSmall">Clasificación 2: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"for="formGroupInputSmall">Clasificación 1: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Mayorista: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;"  for="formGroupInputSmall">Estado: </label>
                          <div class="col l6 m6 s6">
                  ...
                  <div class="container" style="margin: 20px">
                    ...
                    <div class="bs-example" data-example-id="form-group-height-sizes">
                      <form class="form-horizontal form-inline">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label  " style="text-align: right; display: inline-block;" for="formGroupInputSmall">Porcion: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-porcion">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label  "  style="text-align: right; display: inline-block;" for="formGroupInputSmall">Calorias: </label>
                          <div class="col l6 m6 s6  ">
                        ...
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label  " style="text-align: right; display: inline-block;" for="formGroupInputSmall">Grasas Totales: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-grasas-totales">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label  " style="text-align: right; display: inline-block;" for="formGroupInputSmall">Grasas Saturadas: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-grasas-saturadas">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label  " style="text-align: right; display: inline-block;" for="formGroupInputSmall">Grasas Trans: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-grasas-trans">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Grasas Mono Insaturada </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-mono-insaturada">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Grasas Poli Saturada: </label>
                          <div class="col l6 m6 s6">
                        ...
                        <div class="form-group col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Colesterol: </label>
                          <div class="col l6 m6 s6">
                            <input class="form-control" type="number" id="info-colesterol">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Sodio: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="number" id="info-sodio">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Total Carbohidratos: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-total-carbohidratos"/>
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Fibra dietetica: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" style="text-align: right; display: inline-block;" id="info-fibra-dietetica"/>
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Azucar: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-azucar">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Proteinas: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-proteinas">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Vitamina A: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-vitamina-a">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Vitamina C: </label>
                          <div class="col l6 m6 s6 ">
                            <input class="form-control" type="text" id="info-vitamina-c">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Calcio: </label>
                          <div class="col l6 m6 s6  ">
                            <input class="form-control" type="text" id="info-calcio">
                          </div>
                        </div>
                        <div class="form-group  col l6 m6 s6">
                          <label class="col l6 m6 s6 form-control-label" style="text-align: right; display: inline-block;" for="formGroupInputSmall">Hierro: </label>
                          <div class="col l6 m6 s6  ">
