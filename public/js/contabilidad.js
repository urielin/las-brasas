        ...
        if($.trim(fecha1) != '' && $.trim(fecha2) != '' ){
              ...
              $.get('obtener-retiro',{fecha1:fecha1,fecha2:fecha2 },function(res){
                  ...
                  $.each(res.retiros, function(index,value){
                      ...
                      if (value.estado == '1') {
                        $('#retiroTabla').append('<tr class="mostrar-detalle"><td>' +value.id_retiros_indice +'</td><td>'+ value.TP_RET_DESCRIPCION +"</td> <td>"+ dateUTC(value.fecha_desde) +"</td><td>"+ dateUTC(value.fecha_hasta) +"</td> <td>"+parseFloat(value.doc_cantidad)+"</td><td>"+ addCommas((parseFloat(value.monto_total)).toFixed(2)) +" </td><td>COMPLETO</td><td>"+ dateUTC(value.fecha_cierre) +"</td><td>"+ value.usuario_cierre +"</td><td>"+ value.observacion +"</td><td>"+ btn_report +"</td></tr>");
                      } else {
                        $('#retiroTabla').append('<tr class="mostrar-detalle"><td>' +value.id_retiros_indice +'</td><td>'+ value.TP_RET_DESCRIPCION +"</td> <td>"+ dateUTC(value.fecha_desde) +"</td><td>"+ dateUTC(value.fecha_hasta) +"</td> <td>"+parseFloat(value.doc_cantidad)+"</td><td>"+ addCommas((parseFloat(value.monto_total)).toFixed(2)) +" </td><td>INCOMPLETO</td><td>"+ dateUTC(value.fecha_cierre) +"</td><td>"+ value.usuario_cierre +"</td><td>"+ value.observacion +"</td><td>"+ btn_report +"</td></tr>");
                      }
                  ...
                  $('#retiroTabla').append('<tr "><td></td><td></td><td></td><td></td><td>'+ cantidad+"</td><td>"+ addCommas((monto).toFixed(2))+"</td><td></td><td></td><td></td><td></td></tr>");
...
$(document).on('click','#buscar-otros-depositos',function(){
    ...
    if($.trim(fecha1) != '' && $.trim(fecha2) != '' ){
          ...
          $.get('obtener-otro-retiro',{fecha1:fecha1,fecha2:fecha2 },function(res){
              ...
              $('#otroRetiroTabla').append("<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>"+ addCommas(montoOtroTotal.toFixed(2)) +"</td></tr>");
